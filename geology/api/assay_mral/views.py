...
from .serializers import AssayMralSerializer
from master.api.pagination import StandardResultsSetPagination
from core.base import BaseViewSet
from .filters import AssayMralFilter

from analytics.models import ExportJob
from analytics.tasks import run_export_job

class AssayMralViewSet(BaseViewSet):
    queryset = AssayMral.objects.select_related("iup").all().order_by("release_mral")
    serializer_class = AssayMralSerializer
    permission_classes = [
        IsAuthenticated,
        RoleReadOnlyForViewer,
        GlobalMasterPermission,
    ...
    filterset_class = AssayMralFilter
    ...
    def download_template(self, request):
        file_path = os.path.join(
            ...
            "imports",
            "templates",
            "lab_assay_mral_import_template.xlsx",
        )
        ...
        return FileResponse(
            open(file_path, "rb"),
            as_attachment=True,
            filename="lab_assay_mral_import_template.xlsx",
