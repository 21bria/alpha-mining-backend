...
from rest_framework.permissions import IsAuthenticated
from .serializers import sampleDupRoaViewSerializer
...
class sampleDupRoaviewSet(MasterBaseViewSet):
    queryset = sampleDuplikatRoa.objects.all().order_by("sample_number")
    serializer_class = sampleDupRoaViewSerializer
