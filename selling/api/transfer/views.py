...
from .serializers import DomeTransferSerializer
from selling.services.dome_transfer import undo_dome_transfer


class DomeTransferViewSet(MasterBaseViewSet):
    queryset = DomeTransfer.objects.select_related(
        "iup",
        "original_dome",
        "dome_second",
        "user",
    ...
    serializer_class = DomeTransferSerializer
    permission_classes = [
        IsAuthenticated,
        RoleReadOnlyForViewer,
        GlobalMasterPermission,
