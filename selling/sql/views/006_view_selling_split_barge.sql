...
CREATE OR REPLACE VIEW view_selling_split_barge AS 
SELECT 
    t1.date_barge_in,
    t1.date_barge_out,
    t1.date_hauling,
    ...
    COALESCE(TRIM(BOTH FROM t6.factory_stock), 'Unlisted'::text) AS factory_stock,
    ...
    LEFT JOIN geology_samples_productions t7 ON t7.kode_batch::text = t1.code_batch_in::text AND t7.iup_id = t1.iup_id
