...
class SourceMinesLoadingLookupViewSet(BaseLookupViewSet):
    permission_classes = [IsAuthenticated]
    queryset = SourceMinesLoading.objects.all().order_by("loading_point")

    search_fields = ["loading_point__icontains", "description__icontains"]

    allowed_value_keys = {"id", "loading_point"}
    allowed_label_keys = {"loading_point"}
    default_value_key = "id"
    default_label_key = "loading_point"
