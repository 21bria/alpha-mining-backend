...
from rest_framework.permissions import IsAuthenticated
from .serializers_mral import sampleCrmMralViewSerializer
...
class sampleCrmMralviewSet(MasterBaseViewSet):
    queryset = sampleCrmMralView.objects.all().order_by("oreas_name")
    serializer_class = sampleCrmMralViewSerializer
