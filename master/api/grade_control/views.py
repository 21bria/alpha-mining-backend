...
class MineGeologiesViewSet(MasterBaseViewSet):
    ...
    export_fields    = ["id", "name","code", "status"]
    template_headers = ["name", "code"]
    ...
    def download_template(self, request):
        file_path = os.path.join(
            ...
            "master",
            "import_templates",
            "grade_control_import_template.xlsx"
        )

        return FileResponse(
            open(file_path, "rb"),
            as_attachment=True,
            filename="grade_control_import_template.xlsx"
        )