...
from mining.models import mineProductionsView,mineProductions
...
class ProductionsViewSet(BaseViewSet):
    ...
    def get_queryset(self):
        qs = self.queryset.order_by("date_production")
...
class ProductionsViewCRUDSet(BaseViewSet):
    ...
    def download_template(self, request):
        file_path = os.path.join(
            ...
            "imports",
            "templates",
            "mining_productions_import_template.xlsx",
        )
        ...
        return FileResponse(
            open(file_path, "rb"),
            as_attachment=True,
            filename="mining_productions_import_template.xlsx",
